          ...
          <div className="p-8 space-y-6">
            ...
            {section === 'general' && (
              <>
                ...
                <Field label="WhatsApp Number" value={settings.whatsappNumber} onChange={v => set('whatsappNumber', v)} placeholder="e.g. 7400162509" hint="We automatically add the +91 country code." />
